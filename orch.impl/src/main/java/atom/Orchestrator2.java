...
@Task(time=1)
public class Orchestrator2 extends Atom { 
...
public Orchestrator2(Command command, String doorId, Type<Integer> robot_id){
...
p12.setAvailable(false);
 Command.writeGOTO( CPT.getVal() , PLACELEFT.getVal() );
 Command.writeOpenDoor( doorId );
